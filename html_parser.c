    ...
    while ((read = getline(&line, &len, fp)) != -1) {
    	    ...
    	    for(i=0; i<Flag+1; i++){
                if(!isalpha(line[0])) {
                    ...
                    if(strcmp(&line[i], "\"") == 0) {
                        ...
                        printf("indexOfFirstDQuote: %d", indexOfFirstDQuote);
                        break;
                    }
                    line[i] = ' ';
                }//if(!isalpha(line[0])) 
       ...
       /*    int i;
        ...
        if(countOpenTags == 1) { //if countOpenTags==1
            ...
            printf("indexOfLastOpen: %d ", indexOfLastOpen);
            ...
            //for(int i)
                ...
                printf("Chars of line[j] after first closing tag: ");
                ...
                printf("copyBuff: %s \n", copyBuff); //text after closing tag of first tag and open tag of 
                //middle tag
                ...
                */
                ...
                printf("Chars of middle extra tag: ");
              ...
              //  printf(" \n SIZE OF BUFFER: %lu \n", sizeof(buffer));
                ...
                printf("\n newBuff In one extra tag else : %s \n", newBuff);
